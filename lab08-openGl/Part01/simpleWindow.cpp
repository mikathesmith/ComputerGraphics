...
bool initWindow(std::string windowName){
    ...
    window = glfwCreateWindow( 2880, 1800, windowName.c_str(), glfwGetPrimaryMonitor(), NULL);
    if( window == NULL ){
 ...
 *  In the next examples we will see how the rendering will be done here.
 ...
 will cotain all the code for rendering objects to the screen. 
 */
void renderLoop(){
...
int main( void )
{
	...
	// Ensure we can capture the escape key being pressed below - ensures that keyboard intput can be captured 
