...
void Triangle::init(){
	//init the default triangle
    //x,y,z
    //in the array, each vertex is represented by three subsequent floats (x, y, z). 
    ...
    //create a vertexbuffer and pass our vertex data to it
...
void Triangle::render(Camera* camera){
    bindShaders();
	//these parameters could change in each rendering step
    ...
    glVertexAttribPointer(
                          ...
                          GL_FLOAT,           // type
                          GL_FALSE,           // normalized?
                          0,                  // stride - representing a packed vbo - see lecture
