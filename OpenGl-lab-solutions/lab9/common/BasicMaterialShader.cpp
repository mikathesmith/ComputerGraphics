...
void BasicMaterialShader::init(){
	...
	glUniform3f(m_lightColID, m_lightCol.x, m_lightCol.y, m_lightCol.z);
...
void BasicMaterialShader::setLightColour(glm::vec3 lightCol){
	m_lightCol= lightCol;
	glUniform3f(m_lightColID, lightCol.x, lightCol.y, lightCol.z);
}
