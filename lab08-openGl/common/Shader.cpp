...
void Shader::initShaders(std::string vertexshaderName, std::string fragmentshaderName){
    //loadshaders takes two strings that contain the names of the vertex and the fragmentshader program code. 
...
void Shader::bind(){
	...
	// Use our shader with the programID we created using loadShaders
